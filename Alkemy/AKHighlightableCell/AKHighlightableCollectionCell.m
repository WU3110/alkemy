//
//  AKHighlightableCollectionCell.m
//  AlkemyTest
//
...
#import "AKHighlightableCollectionCell.h"

@interface AKHighlightableCollectionCell ()
@property (nonatomic, strong) UIView *highlightenView;
@end

@implementation AKHighlightableCollectionCell
